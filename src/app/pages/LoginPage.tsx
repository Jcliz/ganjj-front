        ...
        <div className="login-panel">
          <div className="login-panel__overlay">
            <div className="login-panel__quote">
              <p className="login-panel__quote-text">"Beautifully Functional.<br />Purposefully Designed."</p>
              <p className="login-panel__quote-sub">Consciously Crafted for you.</p>
            </div>
          </div>
        </div>
        ...
        <div className="login-form-side">
          <div className="login-form-card">
            ...
            <div className="login-form-card__header">
              <p className="login-form-card__title">Sign In</p>
