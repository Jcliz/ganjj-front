...
type CollectionKey = "tudo" | "ss25" | "essenciais" | "masculino";
...
const PHOTOS: LookPhoto[] = [
  {
    ...
    collection: "ss25",
    title: "coleção - vento",
    subtitle: "SS25 · Essenciais leves",
    span: "wide",
  },
  {
    id: 2,
    ...
    collection: "ss25",
    title: "Camada urbana",
    subtitle: "ss25 · O casaco definitivo para a rua",
    span: "tall",
  },
  {
    id: 3,
    ...
    title: "Vestida com poder",
    subtitle: "Essenciais · Elegância",
    span: "normal",
  },
  {
    id: 4,
    ...
    collection: "essenciais",
    title: "Capítulo do jeans",
    subtitle: "Essenciais · Jeans reta",
    span: "normal",
  },
  {
    id: 5,
    ...
    collection: "ss25",
    title: "Texturas aconchegantes",
    subtitle: "SS25 · Costurado para o conforto",
    span: "tall",
  },
  {
    id: 6,
  ...
  },
  {
    ...
    collection: "ss25",
    title: "Jaqueta da meia-noite",
    subtitle: "SS25 · Edição do casaco",
    span: "wide",
  },
  {
    id: 8,
  ...
  },
  {
    ...
    subtitle: "Essenciais · Texturas e tecidos",
    span: "tall",
  },
  {
    id: 10,
    ...
    collection: "masculino",
    title: "Quieto, em paz",
    subtitle: "Masculino · Essenciais do dia a dia",
    span: "normal",
  },
  {
    id: 11,
...
export function LookbookPage() {
  ...
  const filtered = PHOTOS.filter(p => activeCol === "tudo" || p.collection === activeCol);
    ...
    <div className="page">
      ...
      <section className="lb-page-hero">
        <div className="lb-page-hero__content">
          <p className="lb-page-hero__season">LOOK BOOK GANJJ</p>
          <h1 className="lb-page-hero__title">Vestido para a<br />Vida real</h1>
          <p className="lb-page-hero__sub">
            Registros de peças que adoramos —<br />
            feitas para serem usadas, não apenas admiradas.
          </p>
        </div>
      </section>
